...
function configServiceAuth(gitAccessToken) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!accessToken) {
            return Promise.reject(new Error('Unable to authenticate using github token'));
        }
        return accessToken;
    });
}
function getRepoConfig(repo, configServiceToken) {
    return __awaiter(this, void 0, void 0, function* () {
        const { data } = yield axios_1.default
...
function connectContainerToNetwork(cAxios, config) {
    return __awaiter(this, void 0, void 0, function* () {
        core.debug(`Connecting Container ${config.CLUSTER_CONTAINER_NAME} to Network ${config.CONTAINER_NETWORK_NAME}`);
        return cAxios({
            method: 'post',
